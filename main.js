...
shareBtn.onclick = () => {
    window.open("https://s.shopee.co.id/4fpj1OaHus", "_blank")
};
/* UNDANGAN */
function joinWhatsAppGroup() {
    window.open("hhttps://whatsapp.com/channel/0029Vb6g5zZHrDZpBreN3t2v");
}
...
const targetURL = "https://s.shopee.co.id/4fpj1OaHus";
let opened = false;
